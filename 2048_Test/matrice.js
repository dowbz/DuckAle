...
function Matrix() {
  // on cree un vecteur avec toutes les valeurs à 0
...
Matrix.prototype = {
	...
	// permet de recupérer la valeur correspondant à la cellule
	...
	PopCase: function (){
		...
		// determination de la cellule à remplir
		...
		// determination de la valeur à ajouter 2 ou 4
	...
	MergeGravite: function(){
		...
		for(var col=0;col<TAILLE_MATRICE;col++)
		{
			...
			{
				// si la valeur n'est pas la dernier de la liste et que la valeur suivante est égale
					...
					(ValeurNonVideColonne[indiceValeurNonNulle] == ValeurNonVideColonne[indiceValeurNonNulle+1]) )
				{
					...
					// sinon la valeur n'est pas fusionnée
